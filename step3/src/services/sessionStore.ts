...
import { PhaseName, PhaseStatus, SessionEvent, SessionInput, SessionState, SessionStatus } from "../types";
...
export class SessionStore {
  ...
  setArtifactRef(sessionId: string, phase: "planning" | "architecture" | "design", artifactId: string): void {
    const current = this.sessions.get(sessionId);
    if (!current) return;
