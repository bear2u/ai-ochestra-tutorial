...
export type Step4Artifact = PlanArtifact | ArchitectureArtifact | DesignArtifact | ValidationArtifact;
...
export interface SessionState {
  ...
  artifactRefs?: Partial<Record<"planning" | "architecture" | "design" | "validation", string>>;
  startedAt: string;
  endedAt?: string;
  finalSummary?: string;
}
